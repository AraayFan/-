...
INSERT INTO movieInfo (movie_title,movie_url,movie_score,movie_img,movie_tags) VALUES('海上钢琴师','https://movie.douban.com/subject/1292001/','9.2','https://img1.doubanio.com/view/photo/s_ratio_poster/public/p511146807.webp','剧情,音乐');
...
insert into user(user_name,user_pass,user_icon) values('萝卜丝','admin','llq.png');
...
insert into movieReview (movie_id,user_id,review_content,review_img) values(1,1,'非常不错的电影,值得一看','Rwby联动1.gif');
